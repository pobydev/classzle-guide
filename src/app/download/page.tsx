                    ...
                    <div className="p-10 md:p-16 text-center">
                        ...
                        <div className="bg-slate-50 rounded-2xl p-8 max-w-md mx-auto border border-slate-200">
                            ...
                            <div className="text-left mb-8">
                                <div className="text-3xl font-bold text-slate-900">v1.2.1</div>
                                <div className="text-sm text-slate-500 mt-1">2025년 12월 24일 배포</div>
                            </div>

                            <a
                                href="https://github.com/pobydev/Classzle/releases/download/v1.2.1/Classzle.Setup.1.2.1.exe"
